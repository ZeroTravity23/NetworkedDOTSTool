...
public struct SpawnerSnapshotData : ISnapshotData<SpawnerSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref SpawnerSnapshotData baseline1, ref SpawnerSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref SpawnerSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref SpawnerSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref SpawnerSnapshotData target, float factor)
    {
